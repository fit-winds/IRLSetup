...
date.breaks <- seq.POSIXt(asos.setup$roundvalid[1] - hours(3),
                          gefs.setup.recent$validtime[40], by = '24 hours')
...
#        units = 'in', dpi = 150)
ggsave(paste(getwd(), '/../docs/img/raw_setup.png', sep = ''), width = 8, height = 6,
       units = 'in', dpi = 150)
```
...
Real time coastal wind, wave, and water level guidance for the IRL is provided by the [Florida Tech ADCIRC Storm Guidance System (FIT-ASGS)](https://fl-asgs.github.io/ECFL-IRL/).

## Reference

Colvin, J, S. Lazarus, M. Splitt, R. Weaver, and P. Taeb, 2017: In preparation.
